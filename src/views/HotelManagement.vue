<template>
  <div class="details">
      ...
      <div class="detials__wrapper">
          <div class="container">
              <h1>Hotel Management Solution</h1>
              <p>If you own or management a hotel, this is the real deal for you!</p>
          </div>
      </div>
      <div class="details__content">
          <div class="container">
              <div class="row">
                  <div class="col-md-7">
                      <img src="../assets/images/hotel3.png" class="img-fluid" alt=""><br><br>
                  </div>
                  <div class="col-md-5">
                      <h3>Complete Hotel Management Solution</h3>
                      <hr>
